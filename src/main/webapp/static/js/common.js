	    ...
	    "<a class='navbar-brand' style='color:#fff'>FUJAIRAH-数据中心</a></div>"+
	  		"<div class='collapse navbar-collapse titlemain' id='bs-example-navbar-collapse-1'>"+
	    		"<ul class='nav navbar-nav'>"+
			      ...
			      "<li><a class='record' href='./feeDetail.html'>情感分析</a></li>"+
			      "<li><a class='record' href='./feeStatistics.html'>XXX</a></li>"+
			      "<li><a class='record' href='./question.html'>XXX&XXX</a></li></ul></div>");
